...
class OAuthYahooJpServiceTest extends TestCase
{
    /**
    ...
    function yahooJp($code, $nonce, $ts, $stt1, $stt2, $stt3, $token, $pubkeys) {
        $svc = new OAuthYahooJpService();
        $svc->conf['client_id'] = 'dj00aiZpPXpiNE1PVUJFVDYyTyZzPWNvbnN1bWVyc2VjcmV0Jng9YTI-';
        ...
        return $svc->validate($code."\t".$nonce."\t".config('tamuro.oauth_yahoo_jp')['client_id']);
    }
    ...
    /**
     * The test of method validate() --> NG(3).
     *
     * @return void
     */
    ...
    /**
     * The test of method validate() --> NG(4).
     *
     * @return void
     */
    ...
    /**
     * The test of method validate() --> NG(5).
     *
     * @return void
     */
    ...
    /**
     * The test of method validate() --> NG(6).
     *
     * @return void
     */
    ...
    /**
     * The test of method validate() --> NG(7).
     *
     * @return void
     */
...
EOT;
    ...
    public function testVerifyPayloadYahooJp()
    {
        ...
        $payload1 = json_decode(preg_replace(
            '/valid_client_id/',
            config('tamuro.oauth_yahoo_jp')['client_id'],
            <<<EOT
{
