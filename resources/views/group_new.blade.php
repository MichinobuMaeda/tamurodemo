        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{ route('groups') }}">
            ...
            <div class="form-group row">
              ...
              <label for="higher" class="col-md-3 col-form-label text-md-right">{{ __('Higher group') }}</label>
              <p class="col-md-9">
                <select id="higher" name="higher" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}">
                  <option value="">--</option>
