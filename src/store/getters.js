...
export const isTab = state => state.layoutSize.width < state.conf.styles.showTabMaxWidth
export const menuPosition = state => (state.me && state.me.menuPosition) || state.preferences.menuPosition || null
export const locale = state => (state.me && state.me.locale) || state.preferences.locale || null
export const timezone = state => (state.me && state.me.timezone) || state.preferences.timezone || null
