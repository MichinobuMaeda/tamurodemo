...
export const theme = {
  ...
  themes: {
    light: {
      ...
      theme1: colors.lightBlue.lighten4,
      theme1r: colors.lightBlue.darken4,
      theme2: colors.indigo.lighten4,
      theme2r: colors.indigo.darken4,
      menu: colors.indigo.darken2,
      'menu-item': colors.indigo.darken4,
      'menu-item-manager': colors.deepOrange.darken3,
      h2: colors.indigo.darken3,
      h3: colors.lightBlue.darken4,
      title: colors.brown.darken3,
      deleted: colors.blueGrey.lighten3,
    ...
    dark: {
      ...
      theme1: colors.lightBlue.darken4,
      theme1r: colors.lightBlue.lighten4,
      theme2: colors.indigo.darken4,
      theme2r: colors.indigo.lighten4,
      menu: colors.indigo.lighten2,
      'menu-item': colors.indigo.lighten4,
      'menu-item-manager': colors.deepOrange.lighten1,
      h2: colors.indigo.lighten3,
      h3: colors.lightBlue.lighten4,
      title: colors.brown.lighten3,
      deleted: colors.blueGrey.darken1,
      dialogTitle: colors.grey.darken2,
      dialogAction: colors.grey.darken3,
      google_com: '#EA4436',
      apple_com: '#333333',
      facebook_com: '#4267B2',
      github_com: colors.grey,
      microsoft_com: '#8662C5',
      twitter_com: '#1DA1F2',
      line_me: '#00C300',
      yahoo_co_jp: '#FF0132',
